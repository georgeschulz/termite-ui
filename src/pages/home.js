...
function Home() {
    ...
    return (
        <div>
            ...
            <ContentContainer>
                <section className='md:pt-12 md:px-16 lg:pt-12 lg:px-16'>
                    <div className='grid grid-cols-5 gap-10 px-5'>
                        <div className='bg-white rounded-lg shadow-lg px-12 pt-10 pb-8 lg:col-span-3 md:col-span-5'>
                        ...
                        <div className="col-span-2 lg:block md:hidden">
